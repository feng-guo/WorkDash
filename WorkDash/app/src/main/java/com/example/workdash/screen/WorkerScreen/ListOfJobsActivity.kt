...
class ListOfJobsActivity : AppCompatActivity() {
    ...
    private lateinit var jobList: LiveData<List<JobModel>>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        jobList = jobViewModel.getJobList()
    }
                    ...
                    Column(
                        ...
                        LazyRow(
                            ...
                            items(jobViewModel.jobList) { job ->
                                com.example.workdash.screen.WorkerScreen.ProcessingJobCard(
                                    job = job,
                                    navController = navController
                                )
                            }
                ...
                Card(
                    ...
                    Column(
                        ...
                        LazyColumn(
                            ...
                            items(jobViewModel.jobList) { job ->
                                com.example.workdash.screen.WorkerScreen.JobCard(
                                    job = job,
                                    navController = navController
                                )
                            }
